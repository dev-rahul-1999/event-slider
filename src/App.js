...
const App = () => {
  ...
  <img  className={classes.image1} src='./assets/layer 1.svg'/>
  <img className={classes.image2} src='./assets/Layer 2.svg'/>
  <img className={classes.image3} src='./assets/Layer 3.svg'/>
  <img className={classes.image4} src='./assets/Layer 4 .svg'/>
